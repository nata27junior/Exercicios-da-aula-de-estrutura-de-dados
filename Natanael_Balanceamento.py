...
def esta_balanceada(expressao):
    ...
    if expressao==(''):
        ...
        return True
    for i in expressao:
        if parenteses2 not in i or colchete2 not in i or  chaves2 not in i:
            return False
        elif parenteses1  in expressao and colchete1  in expressao and chaves1  in expressao:
            if parenteses1 in expressao :
                pilha.empilhar(parenteses2)
                return True
            elif colchete1 in i :
                pilha.empilhar(colchete2)
                return True
            elif chaves1 in i :
                pilha.empilhar(chaves2)
                return True
