# arvore binaria de busca,  para qualquer noh os menores a esquerda e maiores a direita
# n log(n)
# altura do noh é igual maximo da altura dos filhos
# se o minimo menos o maximo for maior que 1 tah desbalanceada
# recursividade ou pilha
#
#
class Noh:
